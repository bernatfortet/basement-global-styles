...
exports.spacingProps = function (props) {
    var keys = Object.keys(props).filter(function (key) { return REG.test(key); });
...
exports.boxProps = styled_components_1.css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  ", "\n\t", "\n\t", "\n\t", "\n\t", "\n"], ["\n  ", "\n\t", "\n\t", "\n\t", "\n\t", "\n"])), exports.dimensionProps, exports.spacingProps, exports.flexProps, exports.positionProps, exports.appearanceProps);
