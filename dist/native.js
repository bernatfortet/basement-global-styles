...
exports.Column = styled_components_1.default(Root)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  ", "\n  ", "\n\t", "\n  ", "\n"], ["\n  ", "\n  ", "\n\t", "\n  ", "\n"])), function (p) { return p.hCenter ? global_styles_1.s.aic : ''; }, function (p) { return p.vCenter ? global_styles_1.s.jcc : ''; }, primitive_1.boxProps, global_styles_1.s.flxCol);
exports.Row = styled_components_1.default(Root)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  ", "\n\t", "\n\t", "\n  ", "\n"], ["\n  ", "\n\t", "\n\t", "\n  ", "\n"])), function (p) { return p.hCenter ? global_styles_1.s.jcc : ''; }, function (p) { return p.vCenter ? global_styles_1.s.aic : ''; }, primitive_1.boxProps, global_styles_1.s.flxRow);
exports.Box = styled_components_1.default(Root)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n\t", "\n\t", "\n\t", "\n"], ["\n\t", "\n\t", "\n\t", "\n"])), primitive_1.boxProps, function (p) { return (p.column || p.col) ? global_styles_1.s.flxCol : ''; }, function (p) { return p.row ? global_styles_1.s.flxRow : ''; });
